...
export const metadata: Metadata = {
  title: "ATLAS preview",
  description:
    "ATLAS is glomotec's sovereign mobility intelligence preview for policy makers and free zone authorities.",
};
  ...
  return (
    <>
      <PageHeader
        ...
        description="Phase 1 scaffold. ATLAS extends the INDEX scoring engine to jurisdiction-level dashboards for free zone authorities, ministries, and policy teams."
      />
